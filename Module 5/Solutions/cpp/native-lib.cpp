...
extern "C"
{
    JNIEXPORT void JNICALL Java_com_arm_malideveloper_simplecube_NativeLibrary_init(
            JNIEnv * env, jclass type, jint width, jint height){
                setupGraphics(width, height);
    };
    JNIEXPORT void JNICALL Java_com_arm_malideveloper_simplecube_NativeLibrary_step(
